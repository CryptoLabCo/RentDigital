			            ...
			            <div className="col-lg-12 align-self-center">
			              <div className="slide-item-info">
			                <div className="slide-item-info-inner ltn__slide-animation">
			                  <h6 className="slide-sub-title white-color--- animated"><span><i className="fas fa-home" /></span> Real Estate Investments</h6>
			                  <h1 className="slide-title animated ">Find Your Dream <br /> Investment</h1>
			                  <div className="slide-brief animated">
			                    <p>Invest in high yield real estate from anywhere in the world. Powered by blockchain.</p>
			                  </div>
			                </div>
			              </div>
			            </div>
